...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 11 déc. 2023 à 12:26
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `NOMCLIE` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `PRENOMCLIE` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `ADRESSECLIE` char(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `VILLECLIE` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `CODEPOSTALCLIE` char(5) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `TITRECLIE` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `NROTELCLIE` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ingredient` (
  `CODEINGR` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `NOMINGR` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `UNITEINGR` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `livreur` (
  ...
  `NOMLIVR` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `PRENOMLIVR` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pizza` (
  ...
  `DESIGNPIZZ` char(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `TARIFPIZZ` decimal(5,2) DEFAULT NULL,
  PRIMARY KEY (`NROPIZZ`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=457 DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
ALTER TABLE `commande`
  ADD CONSTRAINT `FK_FAIT` FOREIGN KEY (`NROCLIE`) REFERENCES `client` (`NROCLIE`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_LIVRE` FOREIGN KEY (`NROLIVR`) REFERENCES `livreur` (`NROLIVR`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `composer`
--
ALTER TABLE `composer`
  ADD CONSTRAINT `FK_COMPOSER` FOREIGN KEY (`CODEINGR`) REFERENCES `ingredient` (`CODEINGR`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_COMPOSER2` FOREIGN KEY (`NROPIZZ`) REFERENCES `pizza` (`NROPIZZ`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Contraintes pour la table `lister`
--
ALTER TABLE `lister`
  ADD CONSTRAINT `FK_LISTER` FOREIGN KEY (`NROPIZZ`) REFERENCES `pizza` (`NROPIZZ`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `FK_LISTER2` FOREIGN KEY (`NROCMDE`) REFERENCES `commande` (`NROCMDE`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
